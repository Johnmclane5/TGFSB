        ...
        if len(m.command) > 1:
            ...
            if verify_token(user_id, provided_token):
                ...
                await StreamBot.send_message(
                    Var.ADMIN_ID, f"User🕵️‍♂️ {user_link} with 🆔 {user_id} verified the token🎟")
            else:
                ...
                await StreamBot.send_message(
                    Var.ADMIN_ID, f"User🕵️‍♂️ {user_link} with 🆔 {user_id} tried the wrong link")
        else:
            ...
            sent_message = await m.reply("Welcome! To 🗄File-Stream-Boy👦, Please verify✅ your token🎟:", reply_markup=keyboard)
            await StreamBot.send_message(Var.ADMIN_ID, f"User🕵️‍♂️ {user_link} with 🆔 {user_id} Joined")
